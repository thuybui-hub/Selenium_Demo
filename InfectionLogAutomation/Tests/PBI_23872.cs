...
namespace InfectionLogAutomation.Tests
{
    ...
    public class PBI_23872 : TestBase
    {
        ...
        [Description("IO Log - Roles and Permission Updates: Team: DDH & admin are able to view/edit/delete Resident Log Entry")]
        ...
        [Description("IO Log - Roles and Permission Updates: Some roles have no permission to access Resident Log Entry")]
        ...
        [Test, Sequential]
        [Description("IO Log - Roles and Permission Updates: RDH is able to view/edit Resident Log Entry and unable to delete a Resident Log Entry")]
